package com.dong.kotlin.domain

import com.dong.kotlin.domain.constant.SkillType
import com.dong.kotlin.domain.entity.*
import com.dong.kotlin.domain.repository.*
...
class DataInitializer(
    ...
    fun initializeData() {
        ...
        project1.addDetails(
            mutableListOf(
                ProjectDetail(
                    content = "구글 맵스를 활용한 유기묘 발견 지역 정보 제공 API 개발", url =
                        null, isActive = true
                ),
                ProjectDetail(
                    content = "Redis 적용하여 인기 게시글의 조회 속도 1.5초 → 0.5초로 개선", url
                    = null, isActive = true
                )
            )
        )
